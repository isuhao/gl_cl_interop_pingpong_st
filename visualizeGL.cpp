...
{
  m_simulateOpenCLSync = glCreateSyncFromCLeventARB( m_oContext, m_simulateOpenCLEvent, 0 );
  glWaitSync( m_simulateOpenCLSync, 0, GL_TIMEOUT_IGNORED );
  ...
  m_visualizeGLSync = glFenceSync( GL_SYNC_GPU_COMMANDS_COMPLETE, 0 );
}
